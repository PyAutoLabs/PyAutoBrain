...
| `/health full` | **Release-run dashboard**: what the last PyAutoHands release-prep run produced (per-workspace pass/fail/timing, slowest scripts, failure tracebacks). | `PyAutoHeart/skills/pyauto-status-full/reference.md` |
