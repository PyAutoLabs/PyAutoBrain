...
# order in ~/.bashrc.
PYAUTO_LIBS=(PyAutoNerves PyAutoFit PyAutoArray PyAutoGalaxy PyAutoLens PyAutoCTI)
...
export PYAUTO_BRAIN="$root/PyAutoBrain"
export PYAUTO_MIND="$root/PyAutoMind"
export PYAUTO_HEART="$root/PyAutoHeart"
export PYAUTO_HANDS="$root/PyAutoHands"
export PATH="$root/PyAutoBrain/bin:$root/PyAutoHeart/bin:$root/PyAutoHands/bin:\$PATH"
