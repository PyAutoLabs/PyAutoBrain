...
| **PyAutoHeart** | validates the result — the newborn's own symbol audit, link sweep, wiki-currency, harness smoke (Claude Code + Codex), the one-shot benchmark cards run headless with a computed score |
