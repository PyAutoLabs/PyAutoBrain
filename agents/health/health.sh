...
#
# Drives the PyAutoHeart monitoring surface. By default it runs one refresh
# cycle and prints the authoritative readiness verdict. Any subcommand is
# forwarded straight to `pyauto-heart`, so this agent is a thin, named driver
# of Heart rather than a second implementation of any check.
#
# Usage:
...
#
# Future: several health agents may each consume a different slice of Heart
